...
def main():
    ...
    parser.add_argument('--cobol', type=str, default="src/main/resources/cobol/File_COBOL.cbl",
                        help='Path del file COBOL di input')
    parser.add_argument('--sql', type=str, default="src/main/resources/sql/bank_schema.sql",
                        help='Path del file SQL schema (opzionale)')
    parser.add_argument('--output', type=str, default="output/GestioneContiJDBC.java",
