...
- Traduttore COBOL verso Java usando Google Gemini AI
...
**Importante**: Deve esserci esattamente UN file per tipo nella cartella `input/`.
...
### bank_system_cobol - Sistema di gestione conti bancari
- Gestione clienti e conti
- Operazioni di deposito/prelievo
- Generazione estratti conto

### payroll_system_cobol - Sistema di gestione paghe
- Calcolo stipendi e contributi
- Gestione dipendenti
- Generazione buste paga

### warehouse_system_cobol - Sistema di gestione magazzino
- Inventario prodotti
